    ...
    <div class="row">
        <div id="gallery" class="span3">
            <a href="{{asset('images/product_images/large/'.$productDetails['main_Image'])}}" title="Blue Casual T-Shirt">
                <img style="width:100%" src="{{asset('images/product_images/large/'.$productDetails['main_Image'])}}" alt=""/>            </a>
        ...
        <div class="span6">
            ...
            <form method="post" action="{{url('add-to-cart')}}" class="form-horizontal qtyFrm">
                @csrf
                <input type="hidden" name="product_id" value="{{$productDetails['id']}}">
                <div class="control-group">
                    <?php $discounted_price=Product::getDiscountedPrice($productDetails['id']);   ?>

                    <h4 class="getAtrrPrice">
                    ...
                    @if ($discounted_price>0)
                    <h4 class="st" > <font color="red">Discounted Price : {{$discounted_price}}</font> </h4>
                        ...
                        <div class="tab-pane active" id="blockView">
                            <ul class="thumbnails">
                                ...
                                <li class="span3">
                                    <div class="thumbnail">
                                        <?php $product_image_path="images/product_images/small/".$product['main_Image'] ?>
                                        <a href="{{url('product/'.$product['id'])}}" > @if (!empty($product['main_Image'])&&file_exists($product_image_path))
                                            <img style="width: 150px" src="{{asset('images/product_images/small/'.$product['main_Image'])}}" alt=""></a>
